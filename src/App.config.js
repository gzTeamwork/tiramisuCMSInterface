 ...
 * @Last Modified time: 2017-11-24 11:06:13
 */

//  开发模式
let is_dev = 0;
let devReg = new RegExp("(127.0.0.1.*?)|(localhost.*?)", "i");

if (devReg.test(window.location.host)) {
  console.log("本地开发");
  is_dev = 1;
}
//  根目录
...
//  服务器地址(api接口)
let serverUrl = is_dev ? "/server/" : "https://design.logods.cn/public/"; //http://design.logods.cn
